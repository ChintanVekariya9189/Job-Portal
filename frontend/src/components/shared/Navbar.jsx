        ...
        <div className="flex items-center gap-10">
          ...
          {!user ? (
            <div className="flex items-center gap-2">
              ...
              <Link to="/signup">
                <Button className="bg-[#6A38C2] hover:bg-[#4c288b]">
                  Signup
                </Button>
              </Link>
            </div>
            ...
            <Popover>
              <PopoverTrigger asChild>
                <Avatar className="cursor-pointer">
                  <AvatarImage
                    src={userPhoto} // "https://github.com/shadcn.png"
                    alt="@shadcn"
                  />
                </Avatar>
              </PopoverTrigger>
              <PopoverContent className="w-80 bg-white shadow-2xl border-[0.99px] border-black  rounded-md p-4 transition-all duration-200 ease-in-out">
                <div className="">
